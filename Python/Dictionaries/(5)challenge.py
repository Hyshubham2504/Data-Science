...
#                 break
#     if chosen_exit in locations[loc]["exits"]:
#         loc = locations[loc]["exits"][chosen_exit]
#     elif chosen_exit in locations[loc]["namedExits"]:
#         loc = locations[loc]["namedExits"][chosen_exit]
#     else:
